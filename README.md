...
Recollum is a Terminal-based Spaced Repetition flashcard application utilizing the robust SuperMemo 2 (SM-2) algorithm. The backend is built on **Node.js, Express, and SQLite**, fully typed with **TypeScript**.
...
5. **🧠 Review a Card**: This executes the SM-2 learning logic. It will ask for the Card ID and a **Quality Score (0 - 5)**:
   ...
   - `5`: Perfect recall.
   *The interval, repetitions, and easiness factor will multiply and extend the time until you next see the card.*
